class BackpackRemindersController < ApplicationController
  ...
  def index
    ...
    begin
      ...
      #Rails.logger.error "Error: Couldn't retrieve calendars from Backpack for #{@account_user.account_id.to_s}:#{@account_user.user_id.to_s}"
    end
    ...
    begin
      ...
      #Rails.logger.error "Error: Couldn't retrieve reminders from Backpack for #{@account_user.account_id.to_s}:#{@account_user.user_id.to_s}"
    end
